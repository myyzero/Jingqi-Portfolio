...
function getDetailLabels(language: Language) {
  if (language === "zh") {
    return {
      backToWorks: "← 返回作品",
      home: "首页",
  ...
  return {
    ...
    processTexts: {
      research: "Context, references, user needs, and constraints that informed the direction.",
      tasks: "Key tasks and deliverables: design, prototyping, production, implementation.",
      how: "Workflow and tools used to build and iterate the system efficiently.",
      output: "A concise statement of what was produced and what experience it enables.",
    },
    whatWhyTexts: {
      problem:
        "Define the problem this project addresses and why it matters for the audience.",
      insight: "Summarise the key insight that shaped your concept and design decisions.",
      approach:
